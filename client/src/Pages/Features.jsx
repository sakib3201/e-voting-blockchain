function Features() {
  return (
    <div className="flex mt-40 justify-around">
      <div className="rounded-full shadow-lg shadow-blue-300  h-40 ml-16  w-56 ">
      ...
      <div className="h-1 w-40 bg-blue-300 mt-24"></div>
      <div className="rounded-full shadow-lg shadow-blue-300 w-56">
      ...
      <div className="h-1 w-40 bg-blue-300 mt-24"></div>
      <div className="rounded-full shadow-lg shadow-blue-300 h-40  w-56 ">
